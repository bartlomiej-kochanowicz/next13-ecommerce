...
export type CartGetByIdQuery = { order?: { id: string, orderItems: Array<{ quantity: number, product?: { id: string, name: string, description: string, price: number, images: Array<{ url: string }> } | null }> } | null };
...
export type ProductsGetListInCollectionQueryVariables = Exact<{
  slug?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  skip?: InputMaybe<Scalars['Int']['input']>;
}>;
...
export const ProductsGetListInCollectionDocument = new TypedDocumentString(`
